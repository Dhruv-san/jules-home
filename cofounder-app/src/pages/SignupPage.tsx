      ...
      <div className="w-full max-w-md bg-slate-900 shadow-xl rounded-lg p-8">
        ...
        <form onSubmit={handleEmailPasswordSignup} className="space-y-6">
          <div>
            ...
            />
            <p className="mt-1 text-xs text-slate-400">You'll confirm/set this in your profile.</p>
          </div>
          <div>
          ...
          {isError && error && (
           ...
           {needsEmailVerification && isSuccess && (
            <p className="text-sm text-green-400 text-center">Success! Please check your email to verify your account.</p>
          )}
